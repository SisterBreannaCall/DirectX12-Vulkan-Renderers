#include "LightCubeVK.h"

namespace Vulkan
{
	void LightCubeVK::createCube(VkDevice device, VmaAllocator allocator, VkCommandPool commandPool, VkQueue queue, VkRenderPass renderPass, uint32_t images)
	{
		vertices = {
			{{-0.5f, -0.5f, -0.5f}},
			{{ 0.5f, -0.5f, -0.5f}},
	...
	void LightCubeVK::createVertexBuffer(VkDevice device, VmaAllocator allocator, VkCommandPool commandPool, VkQueue queue)
	{
	...
	void LightCubeVK::createUniformBuffers(VkDevice device, VmaAllocator allocator, uint32_t images)
	{
	...
	void LightCubeVK::createDescriptors(VkDevice device, uint32_t images)
	{
	...
	void LightCubeVK::createGraphicsPipeline(VkDevice device, VkRenderPass renderPass)
	{
	...
	void LightCubeVK::updateCube(VmaAllocator allocator, uint32_t images, glm::mat4 viewMatrix, int width, int height)
	{
	...
	void LightCubeVK::recordCube(VkDevice device, VkCommandBuffer commandBuffer, uint32_t image, int width, int height)
	{
		vkCmdBindPipeline(
			commandBuffer,
	...
	void LightCubeVK::cleanUpCube(VkDevice device, VmaAllocator allocator, uint32_t images)
	{
	...
	void LightCubeVK::reloadPipeline(VkDevice device, VkRenderPass renderPass)
	{
		if (enableWireframe)
		{
