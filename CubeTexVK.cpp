...
namespace Vulkan
{
	void CubeTexVK::createCubeTex(VkDevice device, VmaAllocator allocator, VkCommandPool commandPool, VkQueue queue, VkRenderPass renderPass, uint32_t images)
	{
		vertices = {
	...
	void CubeTexVK::createVertexBuffer(VkDevice device, VmaAllocator allocator, VkCommandPool commandPool, VkQueue queue)
	{
	...
	void CubeTexVK::createIndexBuffer(VkDevice device, VmaAllocator allocator, VkCommandPool commandPool, VkQueue queue)
	{
	...
	void CubeTexVK::createTexture(VkDevice device, VmaAllocator allocator, VkCommandPool commandPool, VkQueue queue)
	{
	...
	void CubeTexVK::createUniformBuffers(VkDevice device, VmaAllocator allocator, uint32_t images)
	{
	...
	void CubeTexVK::createDescriptors(VkDevice device, uint32_t images)
	{
	...
	void CubeTexVK::createGraphicsPipeline(VkDevice device, VkRenderPass renderPass)
	{
	...
	void CubeTexVK::updateCubeTex(VmaAllocator allocator, uint32_t images, glm::mat4 viewMatrix, int width, int height)
	{
		for (size_t i = 0; i < images; i++)
		{
			uniformData.model = glm::rotate(glm::mat4(1.0f), (float)glfwGetTime(), glm::vec3(0.5f, 1.0f, 0.0));
	...
	void CubeTexVK::recordCubeTex(VkDevice device, VkCommandBuffer commandBuffer, uint32_t image, int width, int height)
	{
		vkCmdBindPipeline(
			commandBuffer, 
	...
	void CubeTexVK::cleanUpCubeTex(VkDevice device, VmaAllocator allocator, uint32_t images)
	{
	...
	void CubeTexVK::reloadPipeline(VkDevice device, VkRenderPass renderPass)
	{
		vkDestroyPipeline(device, graphicsPipeline, nullptr);
		vkDestroyPipelineLayout(device, pipelineLayout, nullptr);
		createGraphicsPipeline(device, renderPass);
